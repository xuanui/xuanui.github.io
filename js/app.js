  ...
  $(document).ready(function() {
    ...
    $('form#contact_form').validate({
      ...
      submitHandler: function(form) {
        $.ajax({
          type: 'POST',
          url: 'http://drava.blahlab.com/javascripts/send.php',
          data: $(form).serialize(),
...
(function($) {
  Tc.Module.BarGraph = Tc.Module.extend({
    ...
    dependencies: function() {
      // this.require('jquery.ui.core.js'/*tpa=http://drava.blahlab.com/javascripts/jquery.ui.core.js*/, 'plugin', 'onBinding');
    },
    onBinding: function() {
      var $ctx = this.$ctx;
...
(function($) {
  Tc.Module.BlogPost = Tc.Module.extend({
    ...
    dependencies: function() {
      // this.require('slick.min.js'/*tpa=http://drava.blahlab.com/javascripts/slick.min.js*/, 'plugin', 'onBinding');
    },
    onBinding: function() {
      var $ctx = this.$ctx;
...
(function($) {
  Tc.Module.DefaultSlider = Tc.Module.extend({
    ...
    dependencies: function() {
      // this.require('jquery.sequence-min.js'/*tpa=http://drava.blahlab.com/javascripts/jquery.sequence-min.js*/, 'plugin', 'onBinding');
    },
    onBinding: function() {
      var $ctx = this.$ctx;
...
(function($) {
  Tc.Module.Milestone = Tc.Module.extend({
    ...
    dependencies: function() {
      // this.require('jquery.appear.js'/*tpa=http://drava.blahlab.com/javascripts/jquery.appear.js*/, 'plugin', 'onBinding');
    },
    onBinding: function() {
      var $ctx = this.$ctx;
